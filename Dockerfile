...
ARG TMM_URL=https://gitlab.com/tinyMediaManager/tinyMediaManager/uploads/1e473ce8af04196db2c7097aad475d03/tmm_3.1.10_linux.tar.gz
...
RUN cd /tmp && wget https://soft.itbulu.com/fonts/simsun.zip \
    && unzip simsun.zip \
...
RUN \
    sed-patch 's/<application type="normal">/<application type="normal" title="tinyMediaManager \/ 3.1.10">/' \
        /etc/xdg/openbox/rc.xml

# Generate and install favicons.
RUN \
    APP_ICON_URL=https://gitlab.com/tinyMediaManager/tinyMediaManager/-/raw/v3/AppBundler/tmm.png && \
